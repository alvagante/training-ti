...
nodes = [
  ...
  { :hostname => 'tomcat01',  :ip => '10.42.42.81',  :puppetmode => mode },
  { :hostname => 'db01',      :ip => '10.42.42.141', :puppetmode => mode , ram: '512' },
]

# Boxes available
boxes = {
  :Centos65_32   => { :box => 'centos-65-i386-virtualbox-puppet',           :box_url => 'http://puppet-vagrant-boxes.puppetlabs.com/centos-65-i386-virtualbox-puppet.box',           :breed => 'redhat' },
...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: 'vagrant/bin/setup-' + boxes[default_os.to_sym][:breed] + '.sh', args: puppetversion
